	...
	<?php while ( have_posts() ) :  the_post(); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="tribe-events-single-event-description tribe-events-content">
				...
				<!-- Julian Helperstorfer 21.07.2022+13:33 ---- Infos an Anmeldeformular mitliefern für automatisches Befüllen -->
				<?php 
					$event_name = tribe_get_events_title();
					echo $event_name;
					$event_date = tribe_get_start_date($event_id, false, 'Y-m-d');
					$event_venue = tribe_get_venue($event_id);
					$link = "Schulungsanmeldung/?event_name=".urlencode($event_name)."&event_date=".urlencode($event_date)."&event_venue=".urlencode($event_venue);
				?>
